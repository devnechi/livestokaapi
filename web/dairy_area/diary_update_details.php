                                ...
                                <form action="add_new_product.php" method="post">
                                  <div class="panel  panel-default">
                                    <div class="panel-heading card-header">
                                      <h3 class="panel-title title">Livestok Description</h3>
                                    </div>
                                    <div class="panel-body">
                                    <div class="form-group ">
                                        <label for="formGroupExampleInput">Total Number of Cattles</label>
                                        <input type="text" class="form-control"  id="brand_name" name="brand_name"  placeholder="">
                                      </div>
                                      <div class="form-group ">
                                        <label for="formGroupExampleInput">Type of Animal</label>
                                        <select class="form-control" id="country" name="country" >
                                          <option>SELECT</option>
                                          <option>Haifer</option>
                                          <option>Male fattening cattle (> 1 year old) </option>
                                          <option>Lactating</option>
                                          <option>Female calves (less than 1 year old) </option>
                                          <option> Male calves (less than 1 year old) </option>
                                        </select>
                                      </div>

...
<div class="container-fluid">
	<div class="row">
                  ...
                  <div class="col-lg-6 col-md-12">
                      <div class="card">
                          <div class="card-header" data-background-color="orange">
                              <h4 class="title">Breeds in Breeder Flock Farms</h4>
                              <p class="category">As of Last Month February, 2018</p>
                          </div>
                          <div class="card-content table-responsive">
                            <div class="form-group">
                              ...
                              <?php
                               ...
                               // $creator_id  = $_POST['user_id'];
                                 ...
                                 if ($logged_breeder_farm_id) {
                                   $hatchery_id  = $logged_breeder_farm_id;
               ...
               <div class="row">
                 <div class="col-md-6">
                   <div class="card">
                     <div class="card-header" data-background-color="orange">
                         <h4 class="title">Industry Breeding Activities</h4>
                         <p class="category">all Breeding activities as of Dec, 2018</p>
                     </div>
                     <div class="card-content table-responsive">
                 ...
                 <div class="col-md-6">
                   <div class="card">
                     <div class="card-header" data-background-color="orange">
                         <h4 class="title">Industry Breeding Production</h4>
                 ...
                 <div class="col-md-6">
                   <div class="card">
                     <div class="card-header" data-background-color="orange">
                         <h4 class="title">Industry Breeding Growth</h4>
                 ...
                 <div class="col-md-6">
                   <div class="card">
                     <div class="card-header" data-background-color="orange">
                         <h4 class="title">Industry Breeding Activities</h4>
                         <p class="category">most preferred breeding activities are as of Dec, 2018</p>
                     </div>
                     <div class="card-content table-responsive">
                 ...
                 <div class="col-md-6">
                  <div class="card">
                    <div class="card-header" data-background-color="orange">
                        <h4 class="title">Breeding Breed Types</h4>
               ...
               <div class="row">
                 <div class="col-md-6">
                   <div class="card">
                     <div class="card-header" data-background-color="orange">
                         <h4 class="title">Breeding Industry Poultry Types</h4>
                 ...
                 <div class="col-md-6">
                  <div class="card">
                    <div class="card-header" data-background-color="orange">
                        <h4 class="title">Day Old Chicks source</h4>
                        <p class="category">Breakdown of DOC sources, 2018</p>
                    </div>
                    <div class="card-content table-responsive">
              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title">Popular Breeding Breeds in Pie Chart</h4>
                            <p class="category">As of Last Month February, 2018</p>
                        </div>
 ...
 -->
            ...
            <div class="col-md-6">
                      <div class="card">
                        <div class="card-header" data-background-color="orange">
                            <h4 class="title">Breeding Capacity Annual Comparison</h4>
                            <p class="category">As of Last Month February, 2018</p>
                         </div>
                         <div class="card-content table-responsive">
                          <!-- <p>This template has a responsive menu toggling system. The menu will appear collapsed on smaller screens, and will appear non-collapsed on larger screens. When toggled using the button below, the menu will appear/disappear. On small screens, the page content will be pushed off canvas.</p> -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card">
                  <div class="card-header" data-background-color="orange">
                      <h4 class="title">Breeding Capacity Monthly Comparison</h4>
                      <p class="category">As of Last Month February, 2018</p>
                  </div>
                  <div class="card-content table-responsive">
                      <!-- <p>This template has a responsive menu toggling system. The menu will appear collapsed on smaller screens, and will appear non-collapsed on larger screens. When toggled using the button below, the menu will appear/disappear. On small screens, the page content will be pushed off canvas.</p>

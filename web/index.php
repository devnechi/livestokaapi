    ...
    <body>
        ...
        <main>
                ...
                <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="images/slider/may.jpeg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="images/slider/cowb.jpeg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="images/slider/stats.jpg" alt="Third slide">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 padding">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Access to analysis and industry reports, tracking and monitoring growth.</p>
                                <a href="#" class="btn btn-outline-secondary">Read More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row text-center">
                <div class="col-md-3">
                    <div class="card">
                        <img src="images/card/statb.jpg" alt="Card-1" class="card-img-top">
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="images/card/lytics.png" alt="Card-2" class="card-img-top">
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="images/card/stata.png" alt="Card-3" class="card-img-top">
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="images/card/busrep.jpg" alt="Card-3" class="card-img-top">
                        <div class="card-body">
                    ...
                    <div class="col-md-4 padding">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Our reporting systems are based on real time data</p>
                                <a href="#" class="btn btn-outline-secondary">Read More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-6">
                <div class="container" style="margin-bottom: 10%;">
                    ...
                    <section class="customer-logos slider">
                        ...
                        <div class="slide"><img src="images/partners/6.png" style="max-height:90px;"></div>
                    </section>
                </div>
            </div>
                  <div class="row justify-content-center text-center">
                      <div class="col-md-4">
                          <div class="card">
                              <img src="images/ft/cube.png" alt="Card-1" class="card-img-top">
                              <div class="card-body">
                                  <h5 class="card-title">Reporting System</h5>
                                  <p class="card-text paragraph-1">Our reporting systems are based on real time data</p>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="card">
                              <img src="images/ft/data.png" alt="Card-2" class="card-img-top">
                              <div class="card-body">
                      ...
                      <div class="col-md-4">
                          <div class="card">
                              <img src="images/ft/pie.png" alt="Card-3" class="card-img-top">
                              <div class="card-body">
                                  <h5 class="card-title">Our Analysis System </h5>
                                  <p class="card-text">Analysis and detailed reports from our analytics system</p>
                              </div>
                          </div>
                      </div>

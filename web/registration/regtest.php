<?php
  ...
  foreach($fields_required as $field){
   ...
   $fields_required= array("gmp_cert_num", "feedbussiness_permit_num", "cert_of_incorporation_num", "premise_cert_num");
   foreach($fields_required as $field){
     $value = trim($_POST[$field]);
     if(!is_numeric($value)){
        ...
        // echo json_encode($response);
          ...
          if ($feed_manufacturer) {
            ...
            // now, compose the content of the verification email, it will be sent to the email provided during sign up
                ...
                $verificationCode = md5(uniqid("livestokamemberaccountverification", true));

                // send the email verification
                $verificationLink = "http://livestoka.com/activate-account.php?code=" . $verificationCode;
                ...
                // send email using the mail function, you can also use php mailer library if you want
                  ...
                  $mail->setFrom('non-reply@livestoka', 'Stint');
		        ...
		        <strong>Well done!</strong> You successfully registered check you emails<a href=\"#\" class=\"alert-link\">to activate your account</a>.
		         ...
		         <strong>Sorry!</strong> we cant seem to set up your account<a href=\"#\" class=\"alert-link\">click here to try again.</a>.
		        </div>";
                }
  ...
  <body>
    ...
    <div class="container">
      <div class="starter-template">
        ...
        <p class="lead">Owners and operators of Feed Manufactures can Register Below.<br> Please fill all the required Fields.</p>
      </div>
      <!--register section -->
                  ...
                  <label for="formGroupExampleInput"><strong>Company Institution/Manufactures Description</strong></label>
                   <hr>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="premise_cert_number" name="premise_cert_num" value="<?= isset($_POST['premise_cert_number']) ? $_POST['premise_cert_number'] : ''; ?>" placeholder="">
                      </div>
                      <div class="form-group">

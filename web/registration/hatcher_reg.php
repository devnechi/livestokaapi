    ...
    <!-- company information -->
            ...
            <div class="container">
                ...
                <div class="card">
                      ...
                      <div class="row">
                        <!-- <div class="col-md-6">
                          ...
                          <div class="form-check">
                              <label class="customcheck">Hatchery
                                <input type="checkbox" checked="checked" name="declaration[]" id="declaration" value="hatchery">
                                <span class="checkmark"></span>
                              </label>
                              <label class="customcheck"> breeding Establishment
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="funkyradio">
                                <div class="funkyradio-success">
                                    ...
                                    <label for="radio1">Hatchery Establishment</label>
                                </div>
                                <div class="funkyradio-success">
                  ...
                  <!-- <div class="form-group">
                    <label for="formGroupExampleInput2">Total incubation capacity Capacity</label>
                    <input type="text" class="form-control" id="total_incubation_capacity" name="total_incubation_capacity" value="<?= isset($_POST['total_incubation_capacity']) ? $_POST['total_incubation_capacity'] : ''; ?>" placeholder=" ">
                  </div> -->
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-check">
                            ...
                            <label class="customcheck">Utility Chicks
                              ...
                              <span class="checkmark"></span>
                              <p><small>i.) Production of eggs for hatching for the production of selected strain, grandparent
stock or commercial chicks.</small>
                              </br>
                            <small>  ii.) Egg production chicks:

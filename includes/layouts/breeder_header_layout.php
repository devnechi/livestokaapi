...
<html>
    <head>
        ...
        <title> livestoka | Breeders Dashboard</title>
        <!-- Bootstrap CSS CDN -->
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                <div class="sidebar-header">
                    <h3> Breeders Dashboard</h3>
                </div>

                <ul class="list-unstyled components">
                    <p style="font-size:800;">Navigation</p>
                    <li><a href="breeders_dashboard.php">Dashboard</a></li>
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu navdropdown">
                        ...
                        <a class="dropdown-item" href="#">Available Tenders</a>
                        <a class="dropdown-item" href="#">My Bid Tenders</a>

                      </div>
                    </li>
                    <li><a href="#">Add New Product to Market</a></li>
                    <li><a href="#">My Products in the Market</a></li>
                    <!-- <li><a href="#">Order Management</a></li> -->
                    <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Order Management</a>
                      <div class="dropdown-menu navdropdown">
                        <a class="dropdown-item" href="#">My Orders</a>
                        <a class="dropdown-item" href="#">my Orders history</a>
                      </div>
                    </li>
                    <li class="active"><a href="create_new_Batch.php" >Add new batch</a></li>
                    <li ><a href="create_new_breedBatch.php" >manage batches</a></li>
                    <li ><a href="create_new_breedBatch.php" >Add new breed</a></li>
                    <li><a href="../../web/breeder/manage_members.php">Manage Breeds</a></li>
